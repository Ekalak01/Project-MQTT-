...
/*
 ...
 $ gcc -Wall -g gtk.c -o gtk -lmosquitto -lpthread  \
...
GtkWidget *window, *pic_window ,*tree_window;
...
GtkWidget *grid, *sub_grid , *sub_grid2 , *pic_grid;
...
void head_button1_callback( GtkWidget *widget, gpointer data ) {
    ...
    if(win_stat){
        ...
        gtk_box_pack_end( GTK_BOX(box), tree_button2, 
...
void tree_button2_callback( GtkWidget *widget, gpointer data ) {
    ...
    //gtk_tree_model_foreach(selection, foreach_func, NULL);
    ...
    f_img = gtk_image_new_from_file("cam1_04-10-2021_01-11-37.jpg");
...
void activate( GtkApplication *app, gpointer user_data ){
    ...
    gtk_header_bar_set_title(GTK_HEADER_BAR(headerbar), "Smoke Detection");
...
//void  gtk_entry_set_max_length(GtkEntry *sub_entry1, gint max);

void sub_activate( GtkApplication *app, gpointer user_data ) {

	

    gtk_widget_hide(head_button1);
...
//////////////////////////////////////////////////////////////////////////////
    ...
    //gtk_widget_override_color(sub_label1,"RED"))
    ...
    //gtk_entry_set_max_length (GTK_ENTRY(sub_entry1),0);
    ...
    /*
    sub_label4 = gtk_label_new("Please enter 1-9");

    gtk_grid_attach (GTK_GRID (sub_grid), sub_label4, 0, 5, 2, 1);
    */
    ...
    if(is_connected){
        ...
        //gtk_widget_override_color(GTK_LABEL(main_status),GTK_STATE_NORMAL,"green");
        ...
        //gtk_widget_override_color(GTK_LABEL(main_status),GTK_STATE_NORMAL,"red");
...
void main_activate( GtkApplication *app, gpointer user_data ) {
    ...
    gtk_widget_set_size_request(pic_box1,400,300);
    ...
    gtk_widget_set_size_request(pic_box2,400,300);
    ...
    gtk_widget_set_size_request(pic_box3,400,300);
...
static gboolean name_pic( gpointer data ) {
...

	{
        ...
        {   
			...
			sprintf(temp_str,"negative_images/neg-%.4d.jpg",run_cou);
